...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AYPaging/AYPaging.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MDatePickerView/MDatePickerView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SplitSlider/SplitSlider.framework"
